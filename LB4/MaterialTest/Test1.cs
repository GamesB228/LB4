...
namespace MaterialTest
{
    ...
    public sealed class MaterialTests
    {
        ...
        {
            var materials = new List<ICostCalculable>
            {
            ...
            double expectedTotal = 5400 + 2000 + 750; // 8775
            Assert.AreEqual(expectedTotal, calculator.TotalCost(materials));
        }
        [TestMethod]
        public void Paint_GetDescription_Test()
        {
            Paint paint = new Paint(150, 5);
            string expected = "Фарба, літрів: 5";
            Assert.AreEqual(expected, paint.GetDescription());
        }
        ...
        public void Empty_Material_List_Test()
        {
            ...
            Assert.AreEqual(0, calc.TotalCost(new List<ICostCalculable>()));
        }
